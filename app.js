...
if(window.__floewBootFallback){
  clearTimeout(window.__floewBootFallback);
  window.__floewBootFallback=null;
}
...
const INITIAL_LOADING_MAX_MS=10000;
...
initialLoadingWatchdog=setTimeout(()=>{
  ...
  if(!state.stories.length){
    status("Haberler yükleniyor, lütfen bekleyin...");
  }
